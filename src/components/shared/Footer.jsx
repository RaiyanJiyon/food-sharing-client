        ...
        <footer className='pb-10'>
            <div className='w-11/12 mx-auto mt-8 md:mt-20'>
                <div data-aos="fade-down">
                    <h2 className='text-3xl font-bold md:text-center'>FoodieFusion</h2>
                    <p className='text-[#09080F99] md:text-center mt-3'>
                        Join our community to share and discover delicious meals, reduce food waste, and connect with fellow food lovers!
                    </p>
                </div>
                ...
                <div data-aos="fade-up" className='grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-0 md:w-4/5 mx-auto'>
                    <nav className='flex flex-col text-[#09080F99]'>
                        ...
                        <a className="link link-hover text-sm pt-2">Recipe Sharing</a>
                        <a className="link link-hover text-sm pt-2">Food Donations</a>
                        <a className="link link-hover text-sm pt-2">Event Hosting</a>
                        <a className="link link-hover text-sm pt-2">Community Meals</a>
                    </nav>
                    <nav className='flex flex-col text-[#09080F99]'>
                        <h6 className="text-[#09080F] text-lg font-bold">Company</h6>
                        <a className="link link-hover text-sm pt-2">About Us</a>
                        <a className="link link-hover text-sm pt-2">Our Mission</a>
                        <a className="link link-hover text-sm pt-2">Contact Us</a>
                    </nav>
                    <nav className='flex flex-col text-[#09080F99]'>
                ...
                <div className="mt-1">
                    <p className='text-[#09080F99] md:text-center mt-3'>
                        Copyright © {new Date().getFullYear()} - All rights reserved by FoodieFusion.
                    </p>
                </div>
            </div>
        </footer>
